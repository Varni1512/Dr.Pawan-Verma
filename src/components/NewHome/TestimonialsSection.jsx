...
const TestimonialsSection = () => {
  const testimonials = [
    {
      id: 1,
      content: `"It's a must read for all the new generation leaders who wants to hone their leadership"`,
      author: 'Manish Mimani',
      position: 'Founder & CEO, Protectt.ai Labs',
      rating: 5,
    },
    {
      id: 2,
      content: `"Highly recommended to practitioners for through on new-age Leadership"`,
      author: 'M. Balachandran',
      position: 'Former Chairman, Bank of India and NPCI',
      rating: 5,
    },
    {
      id: 3,
    ...
    {
      id: 4,
      content: `"This book revolutionized how I see leadership and its impact on growth."`,
      author: 'Anita Desai',
      position: 'Leadership Coach, InnovateX',
      rating: 5,
    },
    {
      id: 5,
      content: `"Essential reading for anyone aspiring to lead with purpose and vision."`,
      author: 'Ravi Kumar',
      position: 'Executive Director, Future Leaders',
      rating: 5,
    },
    {
      id: 6,
      content: `"Offers practical insights and strategies for scaling leadership effectiveness."`,
      author: 'Neha Patel',
      position: 'HR Head, Global Tech',
      rating: 5,
    },
  ];
